...
export default function PwaShell() {
  ...
  return (
    <div className="safe-bottom pointer-events-none fixed inset-x-0 bottom-0 z-50 px-3 pb-3 sm:px-4 sm:pb-4">
      <div className="glass-panel surface-highlight pointer-events-auto mx-auto flex max-w-md flex-col gap-4 rounded-[28px] p-4 sm:p-5">
        ...
        {deferredPrompt ? (
          <button
            ...
            className="min-h-12 rounded-2xl bg-blue-500 px-4 py-3 text-sm font-semibold text-white shadow-[0_16px_40px_rgba(59,130,246,0.32)] transition hover:bg-blue-400"
          >
            Install Media Vault
          </button>
        ) : null}
